...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const LogWebsiteForm = document.querySelector ("#log-website-form")
    logWebsiteForm.addEventListener("submit", (e) => createFormHandler(e))
})
...
function createFormHandler(e) {
    ...
    postWebsite (titleInput, descriptionInput, imageInput, categoryId)
}
